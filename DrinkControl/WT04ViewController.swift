...
class WT04ViewController: FormViewController {
  ...
  //  let header1 = "使用前に適量、休肝日の数、飲みすぎ基準を設定しましょう。\n⚠️当アプリはユーザーの情報を、一切外部に送信しません。"
    let header1 = "使用前に適量、休肝日の数、飲みすぎ基準を設定しましょう。"
    let header2 = "詳しくはこちら"
    let targetAlcDesc = "アプリではお酒ごとに設定されたアルコール濃度と比重から、含まれるおよその数値を計算します。\n厚生労働省の「健康日本21」では節度ある適度な飲酒は20g、女性はその半分から2/3程度とされます。㊟ 年齢、妊娠、体質等々で大きい個人差があるので、自分にあう数値を設定してください。"
    let excessAlcDesc = "厚生労働省の「健康日本21」は、平均１日あたり純アルコール量60g摂取を多量飲酒者と呼びますが、大きな個人差に要注意。"
    let buttonTitle = "ホーム画面へ移動"
    let indicatedAmount = "目安としてはビール(5度）ー＞ロング缶（500ml),日本酒（15度）ー＞ お銚子１合（180ml),焼酎（25度）ー＞コップ１杯0.6合（110ml),ウイスキー（43度）ー＞ダブル１杯（60ml),ワイン（14度）ー＞グラス１杯（180ml),缶チューハイ(5度）ー＞1.5缶（520ml)"
